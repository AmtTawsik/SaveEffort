...
cp "components/SideDrawer/Default.vue" "components/SideDrawer/${toUpperSingular}.vue"
cp "table_configs/${fromLowerSingular}.json" "table_configs/${toLowerSingular}.json"
